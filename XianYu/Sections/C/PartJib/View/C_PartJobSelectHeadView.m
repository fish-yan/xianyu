...
@implementation C_PartJobSelectHeadView
...
- (CGFloat)createSelectButtonArray:(NSArray *)array
{
    for (UIView *view in self.subviews) {
        if ([view isKindOfClass:[C_SelectDeleteView class]]) {
